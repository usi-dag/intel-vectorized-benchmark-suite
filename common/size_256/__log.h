...
inline _MMR_f64 __log_64_scalar(_MMR_f64 x) {
    ...
    return _MM_SETV_f64(val[3], val[2], val[1], val[0]);

}

inline _MMR_f32 __log_32_scalar(_MMR_f32 x) {
    ...
    return _MM_SETV_f32(val[7], val[6], val[5], val[4], val[3], val[2], val[1], val[0]);
...
//    y = _MM_MUL_f64(y, z);
//
//    y = _MM_MADD_f64(e, _MM_SET_f64(-2.12194440e-4), y);
