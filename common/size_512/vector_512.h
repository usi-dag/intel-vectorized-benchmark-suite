...
#define _MM_SUB_i32			  _mm512_sub_epi32
...
#define _MM_RSHIFT_i32 _mm512_srli_epi32
...
#define _MM_SETV_f64      _mm512_set_pd
#define _MM_SETV_f32      _mm512_set_ps
...
#define _MM_VMSEQ_i32		_mm512_eq_epi32_mask // _mm512_cmp_epi32_mask
inline _MMR_MASK_i64 _mm512_eq_epi32_mask(_MMR_i64 a, _MMR_i64 b) {
    return _mm512_cmp_epi32_mask(a, b, _CMP_EQ_OQ);
}


// Fp
#define _MM_VFEQ_f64        _mm512_eq_pd_mask
inline _MMR_MASK_i64 _mm512_eq_pd_mask(_MMR_f64 a, _MMR_f64 b) {
    return _mm512_cmp_pd_mask(a, b, _CMP_EQ_OQ);
}

#define _MM_VFEQ_f32        _mm512_eq_ps_mask
inline _MMR_MASK_i32 _mm512_eq_ps_mask(_MMR_f32 a, _MMR_f32 b) {
...
#define _MM_VFGE_f64        _mm512_ge_pd_mask
inline _MMR_MASK_i64 _mm512_ge_pd_mask(_MMR_f64 a, _MMR_f64 b) {
...
#define _MM_VFLT_f32        _mm512_lt_ps_mask // __mmask16 k1, __m512 a, __m512 b, const int imm8
inline _MMR_MASK_i32 _mm512_lt_ps_mask(_MMR_f32 a, _MMR_f32 b) {
    return _mm512_cmp_ps_mask(a, b, _CMP_LT_OS);
}

#define _MM_VFLE_f64   _mm512_le_pd_mask    //  __builtin_epi_vmfle_1xf64
inline _MMR_MASK_i64 _mm512_le_pd_mask(_MMR_f64 a, _MMR_f64 b) {
...
#define _MM_LOG_f32 		__log_1x32_scalar // _mm512_log_ps
#endif

#ifndef _MM_EXP
#define _MM_EXP
#include "__exp.h"
#define _MM_EXP_f64 __exp_64_scalar
