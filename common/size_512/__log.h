...
inline _MMR_f64 __log_1x64_scalar(_MMR_f64 x) {
    ...
    return _MM_SETV_f64(val[7], val[6], val[5], val[4], val[3], val[2], val[1], val[0]);

}

inline _MMR_f32 __log_1x32_scalar(_MMR_f32 x) {
    ...
    return _MM_SETV_f32(val[15], val[14], val[13], val[12], val[11], val[10], val[9], val[8], val[7], val[6], val[5], val[4], val[3], val[2], val[1], val[0]);
