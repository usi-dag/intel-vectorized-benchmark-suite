...
static void BM_somier(benchmark::State& state) {
    for (auto _ : state) {
...
BENCHMARK(BM_somier)->Setup(DoSetup)->Unit(benchmark::kSecond)->MinWarmUpTime(20)->Repetitions(10)->ReportAggregatesOnly(false)->
