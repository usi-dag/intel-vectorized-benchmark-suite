...
#include "./../main.hpp"                // (in the main program folder)	needed to recognized input variables
...
//				unsigned long int gvl = __builtin_epi_vsetvl(NUMBER_PAR_PER_BOX, __epi_e32, __epi_m1);
                ...
                int limit = loop_bound(SPECIES_32, NUMBER_PAR_PER_BOX);
                _MMR_f32 xr2;
                _MMR_f32 xDOT;
                _MMR_f32 xu2;
