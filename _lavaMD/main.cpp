...
#include "./main.hpp"            // (in the current directory)
...
// assing default values
    dim_cpu.cores_arg = arguments[0];
    dim_cpu.boxes1d_arg = arguments[1];
//    NUMBER_PAR_PER_BOX = arguments[2];
    char *outputFile;
...
BENCHMARK(BM_lavaMD)->Setup(DoSetup)->Unit(benchmark::kSecond)->MinWarmUpTime(20)->Repetitions(10)->ReportAggregatesOnly(false)->
