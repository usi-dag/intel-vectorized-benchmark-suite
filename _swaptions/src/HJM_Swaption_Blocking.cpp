...
//                printf("pd[%d] = %f\n", BLOCKSIZE_AUX * i + b, pdDiscountingRatePath[BLOCKSIZE_AUX * i + b]);
            }
        }
        ...
        int limit = loop_bound(SPECIES_64, BLOCKSIZE_AUX);
        ...
        for (b = 0; b < limit; b+=SPECIES_64) {
            ...
            for (i=0;i<=iSwapVectorLength-1;++i){
                  ...
                  xdFixedLegValue = _MM_MADD_f64(xpdSwapPayoffs,xpdSwapDiscountFactors, xdFixedLegValue);
              }
            xdFixedLegValue = _MM_MAX_f64(_MM_SUB_f64(xdFixedLegValue,oNE), zero);

            xdFixedLegValue = _MM_MUL_f64(xdFixedLegValue,_MM_SET_f64(pdPayoffDiscountFactors[iSwapStartTimeIndex*BLOCKSIZE_AUX+b]));
