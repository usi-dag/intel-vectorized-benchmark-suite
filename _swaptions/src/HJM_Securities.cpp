...
BENCHMARK(BM_serial)->Setup(DoSetup)->Unit(benchmark::kMillisecond)->MinWarmUpTime(20)->Iterations(10)->Teardown(DoTeardown);
...
BENCHMARK(BM_vector)->Setup(DoSetup)->Unit(benchmark::kMillisecond)->MinWarmUpTime(20)->Iterations(10)->Teardown(DoTeardown);
